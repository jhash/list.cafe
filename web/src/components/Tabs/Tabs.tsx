...
const Tabs: React.FC<TabsProps> = ({ links, className }) => {
  return (
    <div className={classNames('tabs flex items-end', className)}>
      <div
      ...
      {links.map(({ path, name }, index) => (
        <NavLink
          className="tab tab-lifted flex flex-nowrap items-center gap-x-3.5 whitespace-nowrap px-3 font-semibold"
